      ...
      .subscribe((settingsEdition: Settings) => {
        if (settingsEdition) {
          if (existingSettings) {
            ...
            existingSettings.generateNbSemiTonesAsInpassingNotes = settingsEdition.generateNbSemiTonesAsInpassingNotes;
            existingSettings.generateNbSemiTonesAsNearNotes = settingsEdition.generateNbSemiTonesAsNearNotes;
