...
import { DEFAULT_TIME_SIGNATURES, CHORD_DURATION_UNITS, HALF_TONE_SHARP_CHROMAS, HALF_TONE_FLAT_CHROMAS } from '@app/service/notation.constant ';
...
export class SettingsDialogComponent implements OnInit {
  ...
  private instantiateLists(): void {
    ...
    HALF_TONE_FLAT_CHROMAS.forEach((chroma: string, id: number) => {
      this.generateTonalities.push({ 'id': id, 'name': chroma });
    });
  }
