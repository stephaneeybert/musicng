...
export const DEFAULT_TIME_SIGNATURES: Array<number> = [
  1, 2, 3, 4, 5, 6, 7, 8, 9,
];
...
export const OCTAVE_MIN: number = 0;
export const OCTAVE_MAX: number = 9;
...
export const CHROMAS_MAJOR: Array<string> = [
  "C",
  "Db",
  "D",
  "Eb",
...
export const CHROMAS_MINOR: Array<string> = [
  "C",
  "C#",
  "D",
  "D#",
...
export const CHROMAS_ALPHABETICAL: Array<string> = [
  "C",
  "D",
  "E",
  "F",
...
export const DEFAULT_TONALITY_C_MAJOR: Tonality = new Tonality(
  NOTE_RANGE.MAJOR,
  NOTE_CHROMA_C
);
